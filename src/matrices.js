...
module.exports = {
  identityMatrix, projMatrix, scaleMatrix, translateMatrix, rotateAroundXAxis, rotateAroundYAxis, rotateAroundZAxis, 
  multiplyMatrixAndPoint, multiplyMatrices, combineMatrices,
}